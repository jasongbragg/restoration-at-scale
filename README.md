...
Simulation pipeline for investigating the genetic diversity generated by using different restoration strategies. Seedlings are sampled from a population for large plantings (1,000s–10,000s of seedlings). The goal is to understand diversity in plantings at large scales, beyond the scope of most empirical research.
